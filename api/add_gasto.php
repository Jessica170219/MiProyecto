...
$stmt = $db->prepare("INSERT INTO gastos (categoria, concepto, importe, fecha) VALUES (?, ?, ?, ?)");
$result = $stmt->execute([$categoria, $concepto, $importe, $fecha]);
if ($result) {
    echo json_encode(['success' => true, 'message' => 'Gasto añadido']);
} else {
